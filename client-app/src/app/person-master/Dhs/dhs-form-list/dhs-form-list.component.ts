  ...
  @Component({
    selector: 'app-dhs-form-list',
    templateUrl: './dhs-form-list.component.html',
    styleUrls: ['../../Client/client-form/client-form.component.scss']
  })
  export class DhsFormListComponent implements OnInit {

    personName = 'DHS Staff';
    customizedArray= 'customReport' ;
    columnToSorted= 'dhsStaffID';
    filter= 'dHSStaff';
    tableArray='dHSStaff';
    addLink = "/reports/dhsStaff/new";
    navigateTo = '/reports/dhsStaff/details';
    isSearchAny = true;
    breadcrumbs = [
    ...
    //   tableArray = [];
      ...
      add() {
          this.router.navigate(['/reports/dhsStaff/new']);
      }
      ...
      getPerson(initial: any, end: any) {
          ...
          this.personData = {
              ...
              "endPagination": end,
              "action": "NaN",
              "sort":{"column":"DHSStaffID","mode":"desc"}
          };
          ...
          this.clildFormService.getPerson(this.personData).then(data => {
              ...
              this.reportsViewList = data.dHSStaff;
              this.rowData = data['dHSStaff'];
      ...
      onRowSelected(event) {
          ...
          this.clildFormService.storeId(event.data.DHSStaffID);
          this.router.navigate(['/reports/dhsStaff/details']);
